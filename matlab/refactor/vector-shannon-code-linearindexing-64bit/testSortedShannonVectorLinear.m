...
encModel = sortedAdaptiveCountsVariableCutoffs64(counts,biggestSymbolPerDimension);
decModel = sortedAdaptiveCountsVariableCutoffs64(counts,biggestSymbolPerDimension);
enc = shannonEncoder64(encModel);
dec = shannonDecoder64(decModel);
decodedSymbols = [];
