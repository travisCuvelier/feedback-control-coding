classdef shannonEncoder64 < handle
    ...
    methods
        %constructor
        function obj = shannonEncoder64(model)
            obj.model  = model;         
        end
        ...
        function codeword = encodeSymbol(obj,symbol)
            ...
            while( ~(sufficientlySmall) && (bitsToKeep < obj.wordSize))
                ...
                premask = uint64(2^(obj.wordSize-bitsToKeep)-1); 
            ...
            expansion = shannonEncoder64.binaryExpand(floored,obj.wordSize);
