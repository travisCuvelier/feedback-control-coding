classdef cutoffCounts32 < handle
    %need to make a more infomrative comment, but this is a count model
    %for a symbol assumed to be a strictly positive natural number with an
    %"overflow symbol" equivalent to zero. Works correctly with 
    %"quantizeAndThread.m". The "cutoff" property is the LARGEST symbol 
